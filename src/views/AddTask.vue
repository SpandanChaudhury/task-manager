<template>
    <div class = 'container-add'>
        ...
        <form action="" @submit.prevent>
            <input type="text" placeholder = 'task name' v-model = 'task' required> <br>
            <input type="textbox" placeholder = 'task description(if any)' v-model = 'desc'> <br>
            <input type="date" placeholder = 'deadline' v-model = 'deadline' required> <br>
...
<script>
    ...
    export default{
        ...
        {
            var d = new Date();
            // toDateString('en-US', {timezone: 'Asia/Kolkata'});
            console.log(d);
            var dt = d.getDate();
